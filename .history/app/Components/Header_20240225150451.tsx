    ...
    return (
        <div className="flex h-24 w-full px-10 py-5 bg-[#1A1926] shadow justify-between">
            ...
            <div className="flex flex-row h-full justify-center">
                <Image src={alarm} alt="Notifications" height={35} width={35} className="h-10 w-10 justify-center"/>
                <Image src={share} alt="Share" height={35} width={35} className="h-10 w-10"/>
