    ...
    return (
        <div className="flex h-24 w-full px-5 py-5 bg-[#1A1926] shadow justify-between md:px-10">
            ...
            <div className="flex flex-row h-full items-center gap-4 md:gap-20">
                <Image onClick={routeToAlarm} src={alarm} alt="Alarm" height={35} width={35} className="h-6 w-6 cursor-pointer hover:opacity-85"/>
                <Image onClick={routeToExportOrShare} src={share} alt="Share" height={35} width={35} className="h-6 w-6 cursor-pointer hover:opacity-85"/>
