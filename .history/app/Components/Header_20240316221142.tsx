    ...
    return (
        <div className="flex h-24 w-full px-2 py-5 bg-[#1A1926] shadow justify-between md:px-10">
            ...
            <div className="flex flex-row h-full items-center gap-4 md:gap-20">
                ...
                <button onClick={() => logOut()} className="px-3 py-2 rounded-md text-xs font-small bg-[#E53265] outline-none border-none shadow hover:brightness-110 md:px-5 md:py-2 md:text-sm">Sign out</button>
            </div>
        </div>
    )
}