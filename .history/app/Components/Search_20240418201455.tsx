...
export default function Search() {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-row mx-auto h-10 w-36 items-center gap-2 self-center bg-[#fff] rounded-lg md:w-96 sm:w-80 md:gap-4 md:ml-16">
