...
export default function Home() {
  ...
  return (
    <main className="flex h-screen w-screen bg-[#16141C] justify-center">
      <div className="flex flex-col align-middle items-center mt-60 py-10 px-20 bg-[#1A1926] h-fit rounded-lg gap-6">
        <Image src={logo} alt="Plan-It-Earth Logo" height={100} width={100}/>
        <h1 className="text-white text-3xl font-semibold">Join Plan-It-Earth Today</h1>
