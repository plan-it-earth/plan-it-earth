...
export default function Home() {
  ...
  return (
    <main className="flex h-screen w-screen bg-[#16141C] justify-center">
      <div className="flex flex-col align-middle items-center mt-40 py-10 px-14 bg-[#1A1926] h-fit rounded-lg shadow-md md:">
        <Image src={logo} alt="Plan-It-Earth Logo" height={80} width={80} className="justify-center"/>
        <h1 className="text-white text-2xl font-medium mt-3 lg:text-3xl">Join Plan-It-Earth Today</h1>
