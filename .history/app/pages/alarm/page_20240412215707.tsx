...
export default function Alarm() {
    ...
    return (
        ...
        <div className="bg-[#16141C] h-lvh justify-center">
            ...
            <div className="flex max-w-md mx-auto bg-[#1A1926] mt-6">
                <div className="flex flex-row w-full py-6 text-2xl font-normal justify-between px-4 border border-white rounded-sm">
                    <h1>Note</h1>
                    <h1>Time</h1>
                    <h1>Alarm</h1>
                </div>
