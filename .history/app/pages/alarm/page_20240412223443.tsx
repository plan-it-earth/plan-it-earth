    ...
    */
    ...
    return (
        ...
        <div className="bg-[#16141C] h-lvh justify-center">
            ...
            <div className="flex max-w-md mx-auto bg-[#1A1926] mt-6 border border-white rounded-md">
                <div className="flex flex-row w-full py-6 text-2xl font-normal justify-between px-4">
                    <h1>Note</h1>
                    <h1>Time</h1>
                    <h1>Alarm</h1>
                </div>
                <div> className="flex flex-col w-full">
                    <AlarmRow title="Test Event" time="12:00 PM" alarm={5} id={1} />
                    <AlarmRow title="Test Event" time="12:00 PM" alarm={10} id={2} />
                    <AlarmRow title="Test Event" time="12:00 PM" alarm={15} id={3} />
                    <AlarmRow title="Test Event" time="12:00 PM" alarm={60} id={4} />
                </div>
            </div>
            {/*
