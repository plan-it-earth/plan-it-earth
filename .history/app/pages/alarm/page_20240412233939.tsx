    ...
    */
    ...
    return (
        ...
        <div className="bg-[#16141C] h-lvh justify-center">
            ...
            <div className="flex flex-col max-w-md mx-auto py-8 bg-[#1A1926] mt-6 border border-white rounded-md">
                <div className="flex flex-row w-full pb-6 text-2xl font-normal justify-between px-6 border-b border-b-1 border-white">
                    <h1>Note</h1>
                    <h1>Time</h1>
                    <h1>Alarm</h1>
                </div>
