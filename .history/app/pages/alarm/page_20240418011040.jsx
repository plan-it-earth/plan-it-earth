        ...
        <div className="bg-[#16141C] h-lvh justify-center">
            ...
            <div className="flex flex-col mx-2 sm:mx-36 md:mx-36 lg:mx-36 py-8 bg-[#1A1926] mt-6 border shadow-md border-white rounded-md">
                ...
                <div className="flex flex-col w-full gap-6 mt-6">
                    ...
                    {events.length > 0 ? (
                        <ul className="flex flex-col mt-6 items-center px-6 py-6 w-fit mx-auto gap-4 text-white border-white border rounded-lg shadow-lg">
                            {events.map(event => (
                                <AlarmRow key={event.id} title={event.title} time={`${event.start}`} alarm={event.extendedProps.alarm} id={event.id} />
                            ))}
                        </ul>
                    ) : (
