            ...
            <div className="max-w-md mx-auto mt-16 p-8 bg-[#1A1926] rounded-lg shadow-md border border-white">
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                    <div>
                        ...
                        <input type="text" id="title" name="title" value={formData.title} onChange={handleChange} placeholder="Enter title of note" className="text-white bg-gray-600 mt-1 px-2 py-4 rounded-md" />
                    </div>
                    <div>    
