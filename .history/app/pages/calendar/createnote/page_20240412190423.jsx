                ...
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                    <div>
                        ...
                        <label className="block text-sm font-medium text-gray-200">Select Alarm:</label>
                            <select id="alarm" className="text-white bg-gray-600 mt-1 p-2 rounded-md focus:outline-none">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            rows="4" 
                            cols="30" 
                            className="text-white bg-gray-600 mt-1 p-2 rounded-md focus:outline-none"
