                ...
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            rows="4" 
                            cols="30" 
                            className="text-white bg-gray-600 px-3 mt-1 rounded-md w-full focus:outline-none"
                            placeholder ="Enter note description here...">
                        </textarea>
                    </div>
                    <div>
                        <button type="submit" className="bg-[#E53265] text-white w-full px-4 py-2 rounded-md hover:opacity-85 focus:outline-none">Submit</button>
                    </div>
                </form>
            </div>
        </div>
