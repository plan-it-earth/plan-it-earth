                ...
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                    <div>
                        ...
                        <div className="flex flex-row gap-4">
                            <input type="date" id="date" name="date" required value={formData.date} onChange={handleChange} placeholder="Enter date of note" className="text-white bg-gray-600 mt-1 px-3 py-2 w- rounded-md focus:outline-none" />
                            <input type="text" id="time" name="time" required value={formData.time} onChange={handleChange} placeholder="12:00" className="text-white bg-gray-600 mt-1 px-3 py-2 rounded-md focus:outline-none"/>
