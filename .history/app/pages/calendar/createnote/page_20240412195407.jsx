                ...
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                    <div>
                        ...
                        <div className="flex flex-row gap-4">
                            ...
                            <input type="text" id="time" name="time" required value={formData.time} onChange={handleChange} placeholder="12:00" className="text-white bg-gray-600 mt-1 px-3 py-2 w-11 rounded-md focus:outline-none"/>
