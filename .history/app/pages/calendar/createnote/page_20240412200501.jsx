                ...
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                    <div>
                        ...
                        <div className="flex flex-row justify-between">
                            ...
                            <input type="text" id="time" name="time" required value={formData.time} onChange={handleInputChange} placeholder="12:00" className="text-white bg-gray-600 mt-1 px-3 py-2 rounded-md w-20 text-center focus:outline-none"/>
