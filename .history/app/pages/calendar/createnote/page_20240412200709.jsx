...
export default function CreateNote() {
    ...
    const handleTimeChange =(event) => {
        ...
        inputValue = inputValue.slice(0, 4); // Limit to four digits
        }
                ...
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                    <div>
                        ...
                        <div className="flex flex-row justify-between">
                            ...
                            <input type="text" id="time" name="time" value={time} required value={formData.time} onChange={handleTimeChange} placeholder="12:00" className="text-white bg-gray-600 mt-1 px-3 py-2 rounded-md w-20 text-center focus:outline-none"/>
