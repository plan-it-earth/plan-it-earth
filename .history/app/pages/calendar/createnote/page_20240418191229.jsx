                ...
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                    <div>
                        ...
                        <div className="flex flex-row justify-between">
                            ...
                            <input type="time" id="time" name="time" required value={time} onChange={handleTimeChange} className="text-white bg-gray-600 px-3 py-2 rounded-md h-10 align-middle" />
