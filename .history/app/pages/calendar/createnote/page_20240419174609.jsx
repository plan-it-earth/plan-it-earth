                ...
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                    <div>
                        ...
                        <div className="flex flex-row justify-between gap-4">
                            ...
                            <input type="time" id="time" name="time" value={time} onChange={handleStartTimeChange} className="text-white text-center bg-gray-600 mt-1 px-3 py-2 rounded-md h-full w-full focus:outline-none" />
                        </div>
                        <div className="flex flex-row justify-between gap-4">
                            <input type="date" id="date" name="date" required value={formData.date} onChange={handleDateChange} className="text-white bg-gray-600 mt-1 px-3 py-2 rounded-md w-full dark focus:outline-none" />
