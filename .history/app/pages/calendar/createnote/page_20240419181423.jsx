                ...
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                    <div>
                        ...
                        <div className="flex flex-row justify-between gap-4">
                            ...
                            <input type="time" id="time" name="startTime" value={time} onChange={handleStartTimeChange} className="text-white text-center bg-gray-600 mt-1 px-3 py-2 rounded-md h-full w-full focus:outline-none" />
                        </div>
                        <div className="flex flex-row justify-between gap-4">
                            ...
                            <input type="time" id="time" name="startTime" value={time} onChange={handleEndTimeChange} className="text-white text-center bg-gray-600 mt-1 px-3 py-2 rounded-md h-full w-full focus:outline-none" />
                        </div>
