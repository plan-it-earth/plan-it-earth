...
export default function CreateNote() {
    ...
    const [formData, setFormData] = useState({title: "",startDate: "", endDate: "", alarm: "", image: "", label: "", description: ""});
            ...
            <div className="max-w-md mx-2 sm:mx-auto mt-10 p-8 bg-[#1A1926] rounded-lg shadow-md border border-white">
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                    <div>
                        ...
                        <div className="flex flex-row justify-between gap-4">
                            <input type="date" id="endDate" name="endDate" required value={formData.date} onChange={handleEndDateChange} className="text-white bg-gray-600 mt-1 px-3 py-2 rounded-md w-full dark focus:outline-none" />
