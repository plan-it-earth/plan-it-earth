    ...
    return (
        <div className="bg-[#16141C] min-h-screen">
            ...
            <div className="flex justify-center gap-10">
                <div className="w-50 h-52 p-12 bg-[#1A1926] rounded-lg shadow-md">
                    <Link className="flex flex-col items-center justify-center buttonexportpage" href={{pathname: './exportorshare/sharewith'}}>
                        <Image src={Sharewhite} alt="white share arrow" height={90} width={90} />
                        <span>Share</span>
                    </Link> 
                </div>
                <div className="p-12 w-50 h-50 bg-[#1A1926] rounded-lg shadow-md">
