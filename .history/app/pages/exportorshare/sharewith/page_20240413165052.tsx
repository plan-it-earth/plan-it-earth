...
export default function Home() {
  ...
  return (
    <div className="bg-[#16141C] min-h-screen">
      ...
      <h2 className="flex flex-col items-center justify-center text-2xl font-semibold mb-6 mt-16">Pick a date range to share</h2>
      {/*
      <div className="max-w-md mx-auto mt-16">
        ...
        <div className="mb-8 bg-[#1A1926] rounded-lg shadow-md">
          ...
          {isCalendarOpen1 && (
            <div className="bg-black border rounded-lg shadow-md">
              {/* FullCalendar component for the first date selection */}
            </div>
          )}
        </div>
        ...
        <div className="mb-8 bg-[#1A1926] rounded-lg shadow-md">
          ...
          {isCalendarOpen2 && (
            <div className="bg-black border rounded-lg shadow-md">
              {/* FullCalendar component for the end date selection */}
            </div>
          )}
        </div>
