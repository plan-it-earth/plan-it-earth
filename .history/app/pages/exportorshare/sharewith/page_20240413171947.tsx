  ...
  */
  ...
  return (
    <div className="bg-[#16141C] min-h-screen">
      ...
      <div className="flex max-w-md py-10 px-10 border border-white bg-[#1A1926] rounded-md justify-center mx-auto">
        <div className="flex flex-col w-full gap-2">
          <label>Share with:</label>
          <input type="text" placeholder="johndoe@gmail.com" onChange={handleEmailChange} className="bg-[#35334D] px-3 py-2 rounded-md focus:outline-none"/>
        </div>
      </div>
     {/*
