  ...
  return (
    <div className="bg-[#16141C] min-h-screen">
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col gap-4 max-w-md py-10 px-10 border border-white bg-[#1A1926] rounded-md justify-center mx-auto">
          ...
          <div className="flex w-full mt-4">
            <button type="submit" className="w-full bg-[#35334D] text-white font-bold py-2 px-4 rounded-lg hover:bg-opacity-90 focus:outline-none">Share</button>
          </div>
        </div>
      </form>
     {/*
