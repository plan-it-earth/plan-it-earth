  ...
  return (
    <div className="bg-[#16141C] min-h-screen">
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col gap-4 max-w-md pt-10 px-10 border border-white bg-[#1A1926] rounded-md justify-center mx-auto">
          ...
          <div className="flex w-full mt-2 pb-6">
