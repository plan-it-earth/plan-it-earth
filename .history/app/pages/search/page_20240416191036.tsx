        ...
        <div className="flex flex-col bg-[#16141C]">
            ...
            {events.length > 0 ? (
                <div>
                    ...
                    <div>
                        <button className="mt-8 mx-auto w-fit bg-[#35334D] text-white font-medium py-2 px-4 rounded-lg hover:bg-opacity-90 focus:outline-none" type="button">Download PDF</button>
                    </div>
                </div>
            ) : (
                <p>No events found.</p>
