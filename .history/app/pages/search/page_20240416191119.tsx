            ...
            {events.length > 0 ? (
                <div>
                    ...
                    <div className="flex justify-center mx-auto">
                        <button className="mt-8 mx-auto w-fit text-white font-medium py-2 px-10 rounded-lg hover:bg-opacity-90 focus:outline-none" type="button">Download PDF</button>
                    </div>
                </div>
            ) : (
                <p>No events found.</p>
