    ...
    return (
        <div className="flex flex-col bg-[#16141C]">
            ...
            <div className="flex flex-col justify-center">
                ...
                <input type="date" className="w-52 text-center h-10 mt-6 mb-6 mx-auto bg-[#1A1926] text-white rounded-lg shadow-lg border-none focus:outline-none" />
                <label>End:</label>
                <input type="date" className="w-52 h-10 mt-6 mb-6 mx-auto bg-[#1A1926] text-white rounded-lg shadow-lg border-none focus:outline-none" />
            </div>
            {events.length > 0 ? (
                <div>
