    ...
    return (
        <div className="flex flex-col bg-[#16141C]">
            ...
            <div className="flex flex-col justify-center mx-auto">
                <h3 className="font-medium text-xl">Select start and end date</h3>
                <label className="">Start:</label>
                <input type="date" className="w-fit text-center mt-2 h-10 mb-6 mx-auto bg-[#1A1926] text-white rounded-lg shadow-lg border-none focus:outline-none" />
                <label>End:</label>
                <input type="date" className="w-52 text-center mt-2 h-10 mb-6 mx-auto bg-[#1A1926] text-white rounded-lg shadow-lg border-none focus:outline-none" />
            </div>
            {events.length > 0 ? (
                <div>
