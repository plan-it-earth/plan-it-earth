            ...
            <div className="flex flex-col justify-center mx-auto mt-16">
                ...
                <div className="flex flex-row gap-2">
                    <div>
                        ...
                        <input type="date" value={startDate} required className="w-full text-center mt-2 h-10 mb-6 mx-auto bg-[#1A1926] text-white rounded-lg shadow-lg border-none focus:outline-none" />
                    </div>
                    <div>
                        <label>End:</label>
                        <input type="date" value={endDate} required className="w-full text-center mt-2 h-10 mb-6 mx-auto bg-[#1A1926] text-white rounded-lg shadow-lg border-none focus:outline-none" />
                    </div>
                </div>
            </div>
            {events.length > 0 ? (
